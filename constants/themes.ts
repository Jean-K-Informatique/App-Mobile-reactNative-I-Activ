...
export const DARK_THEME: Theme = {
  name: 'dark',
  backgrounds: {
    primary: '#0a0b0f',      // Couleur widgets comme référence pour toute l'app
    secondary: '#0a0b0f',    // Même couleur pour uniformiser
    tertiary: '#1a1b1f',     // Légèrement plus clair pour les cartes
